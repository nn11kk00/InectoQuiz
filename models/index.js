...
function iniciarJuego(nombreJugador) {
    ...
    jugador.cantPuntos = puntaje;  // Asegúrate de inicializar cantPuntos
    preguntaActual = 0;
...
console.log(jugador.cantPuntos);
...
function finalizarJuego() {
    // Asegúrate de detener cualquier temporizador en curso.
    clearInterval(contadorInterval);
    
    const tiempoTotal = ((Date.now() - tiempoInicioPregunta) / 1000).toFixed(2);
    console.log(puntaje);
    jugador.cantPuntos = puntaje; // Actualizar el puntaje acumulado antes de mostrar resultados
